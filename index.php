...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="flex justify-center">
        <div class="bg-white shadow-lg rounded-lg p-6 text-center w-72">
            <div class="mb-4">
                <i class="fas fa-user-graduate text-blue-500 text-6xl"></i> <!-- Alumni Icon -->
            </div>
            <h5 class="text-xl font-semibold mb-4">ALUMNI</h5>
            <a href="alumni/login.php" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Login As Alumni</a>
        </div>
    </div>
</div>
</body>
