  ...
  <div class="w-full max-w-3xl bg-white p-10 rounded-lg shadow-lg relative space-y-6">  
    ...
    <form id="FrmRegister" class="grid grid-cols-2 gap-6">
      ...
      <div class="col-span-2 bg-white p-6 rounded-2xl shadow-lg border border-gray-300">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" name="companyName" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500" required>
          </div>
          <div>
            <label for="previousWork" class="block text-sm font-medium text-gray-700">Address</label>
            <input type="text" name="previousWork" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500" required>
          </div>
          <div>
            <label for="previousWorkPosition" class="block text-sm font-medium text-gray-700">Position</label>
            <input type="text" name="previousWorkPosition" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500" required>
          </div>
          <div>
            <label for="previousWorkStart" class="block text-sm font-medium text-gray-700">Start</label>
            <input type="text" name="previousWorkStart" class="w-full mt-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500" required>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <input type="password" id="confirm-password" name="confirm-password" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-green-500" required>
      </div>
